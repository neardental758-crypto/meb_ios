...
function Reservar3GScreen(props) {
    ...
    /*const guardar_reserva = async() => {
        ...
        //await props.saveReserva(data, fechaVence.toJSON());//
    ...
    const vehiculoseleccionado = async (data) => {
        ...
        console.log('id de la bicicleta', data.bic_id);
    ...
    useEffect(() => {
        if (props.dataRent.reservaSave) {
            RootNavigation.navigate('Home3G')
        }
...
export default connect(mapStateToProps)(Reservar3GScreen);