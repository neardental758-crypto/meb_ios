    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
            <View style={estilos.cajaCabeza}>
                <Text style={[styles.accountTitle, { fontFamily: Fonts.$poppinsmedium, fontSize: 26, textAlign: 'center', color: Colors.$texto80 }]}>Soporte</Text>
                <Pressable
                    onPress={() => { goBack() }}
            ...
            <SafeAreaView style={{ flex: 1, backgroundColor: 'rgba(255, 255, 255, 0.8)', justifyContent: 'flex-start', alignItems: 'center', padding: 5 }}>
                <View style={{ marginTop: 5, marginHorizontal: 20 }}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginVertical: 10 }}>
                        ...
                        <Text style={{ fontFamily: Fonts.$poppinsregular, fontSize: 16, color: 'black' }}>admon@mejorenbici.com</Text>
                    </View>
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginVertical: 10 }}>
