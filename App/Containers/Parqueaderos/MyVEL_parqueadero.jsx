...
function MyVEL_parqueadero(props){
    ...
    const home = () => {RootNavigation.navigate('Home_parqueadero')}
    const register = () => {RootNavigation.navigate('RegisterVEL_parqueadero')}
            ...
            <ScrollView>
                ...
                <>  
                    ...
                    props.dataRent.myVehiclesVP.data.map((data) => 
                        (data.vus_tipo === 'e-Bike' || data.vus_tipo === 'e-Scooter' || data.vus_tipo === 'e-Moto') || data.vus_tipo === 'Moto' || data.vus_tipo === 'Carro' || data.vus_tipo === 'Carro Eléctrico' ? 
                        <Pressable 
                            key={data.vus_id}
...
export default connect(mapStateToProps)(MyVEL_parqueadero);