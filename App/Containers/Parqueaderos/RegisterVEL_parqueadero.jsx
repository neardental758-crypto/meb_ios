...
function RegisterVEL_parqueadero(props){
                    ...
                    }}>
                    {
                        ...
                        <>
                            ...
                            props.dataRent.tiposVP.data.map((data) =>
                                data.tip_nombre === 'e-Bike' || data.tip_nombre === 'e-Scooter' || data.tip_nombre === 'e-Moto' || data.tip_nombre === 'Moto' || data.tip_nombre === 'Carro' || data.tip_nombre === 'Carro Eléctrico' ?
                                <View
                                    key={data.tip_id}  
...
export default connect(mapStateToProps)(RegisterVEL_parqueadero);