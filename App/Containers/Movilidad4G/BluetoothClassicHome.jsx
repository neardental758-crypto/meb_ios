...
const BluetoothClassic = (props) => {
    ...
    const [touchLiberar, setTouchLiberar] = useState(false); //valor inicial false
    ...
    async function otroTouch() {
        Alert.alert('Ya se envió la solicitud para liberar. ');
    }
