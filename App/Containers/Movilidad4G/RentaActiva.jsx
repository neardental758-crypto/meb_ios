...
import { Tarjeta } from '../ViajeActivo/Tarjeta';
import { BackgroundTask } from '../ViajeActivo/BackgroundTask';

function RentarActiva (props) {
    ...
    const guardarPrestamo = async () => {
        ...
        const data = {
            ...
            "pre_retiro_fecha": state.fecha.toJSON(),
            "pre_retiro_hora": state.horas,
            "pre_devolucion_estacion": estacionPrestamo,
            "pre_devolucion_bicicletero": props.dataRent.idBicicletero,
                    ...
                    <>
                        ...
                        <SafeAreaView style={estilos.contentCenter}>
                            ...
                            <View style={estilos.cajaCod2}>
                                ...
                                <BackgroundTask 
                                    time={(`${minutosV}:${segundosV < 10 ? '0' : ''}${segundosV}`)}
                                />
