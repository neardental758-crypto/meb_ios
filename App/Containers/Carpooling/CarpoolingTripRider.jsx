...
function CarpoolingTripRider(props) {
  ...
  useEffect(() => {
    if (dataCarpooling && dataCarpooling.tripsActiveToRider) {
      const { data, pagination } = dataCarpooling.tripsActiveToRider;
      ...
      // Siempre quitar el loading cuando llegan datos (con o sin paginación)
  ...
  // Timeout de seguridad: si en 8 segundos no hay respuesta, quitar el loading de todas formas
  useEffect(() => {
