...
function CarpoolingSolicitudesRider(props) {
  ...
  useEffect(() => {
    if (dataCarpooling?.riderList !== undefined && dataCarpooling?.riderList !== null) {
      ...
      // Siempre quitar el loading cuando llega una respuesta (con datos o vacía)
      const delay = setTimeout(() => {
        setLoadedTrips(false);
      }, 500);
      return () => clearTimeout(delay);
    }
  }, [dataCarpooling?.riderList]);
