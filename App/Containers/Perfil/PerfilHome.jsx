...
function PerfilHome(props) {
  ...
  return (
    <View style={estilos.contenedor}>
      ...
      <Modal visible={loadingPhoto} transparent={true} animationType="fade">
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', alignItems: 'center' }}>
          <View style={{ backgroundColor: Colors.$blanco, padding: 30, borderRadius: 20, alignItems: 'center' }}>
            <ActivityIndicator size="large" color={Colors.$primario} />
            <Text style={{ marginTop: 20, fontFamily: Fonts.$poppinsmedium, color: Colors.$texto, textAlign: 'center' }}>
